...
<body>
  ...
  <main id="main">
    ...
    <div class="breadcrumbs" data-aos="fade-in">
      <div class="container">
        <h2>Program Pendidikan Ummul Quroo lanjutan..</h2>
   ...
   <p style="text-align:justify;">
    <h1>Program Pendidikan Ummul Quroo</h1><br><br>
